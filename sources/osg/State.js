...
var State = function ( shaderGeneratorProxy ) {
    ...
    this._programAttribute = this._attributeArray[ MACROUTILS.getOrCreateStateAttributeTypeMemberIndex( program ) ];
...
MACROUTILS.createPrototypeClass( State, MACROUTILS.objectInherit( Object.prototype, {
    ...
    applyAttribute: function ( attribute ) {
        ...
        if ( !attributeStack ) {
            attributeStack = this._createAttributeStack( _attributeArray, index, attribute.cloneType() );
        }
